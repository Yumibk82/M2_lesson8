public class TennisGame {
    ...
    public static void displayPoint(int player1Score, int player2Score, StringBuilder score) {
        int tempScore;
        for (int i = 0; i < 3; i++) {
    ...
    private static String checkWin(int player1Score, int player2Score) {
        ...
        if (isPlayer1AdvPlayer2) score = "Advantage player 1";
        else {
            boolean isPlayer2AdvPlayer1 = minusResult == -1;
            if (isPlayer2AdvPlayer1) score = "Advantage player 2";
            else {
